...
import "./compactkey.css";

const CompactKey = ({ showKey }) => {
    const utciKey = [
    ...
    return (
        <AnimatePresence>
            {showKey && (
                <motion.div
                    className="global-chart-compact-key-container"
                    initial={{ height: 0 }}
                    animate={{ height: "auto" }}
                    exit={{ height: 0 }}
                    transition={{
                ...
                >
                    <div className="global-chart-compact-key">
                        <div className="global-chart-compact-key-column">
                            {utciKey
                                .slice(5, 10)
